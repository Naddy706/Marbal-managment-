...
<div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/Invoice/{{$data['s']->id}}">
                        @csrf
                        {{ method_field('PUT') }}
                        <input id="ci" hidden  value="{{$data['ci']->id }}" ><br>
                        <input id="pi"  hidden value="{{$data['pi']->id }}" ><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="Product_Id" name="" class="form-control">
                                <option>--- Select ---</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Invoice_No" type="text" class="form-control @error('Invoice_No') is-invalid @enderror" name="Invoice_No" value="{{$data['s']->Invoice_No}}" required autocomplete="Invoice_No" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Invoice_Date" type="datetime-local" class="form-control @error('Invoice_Date') is-invalid @enderror" name="Invoice_Date" required autocomplete="Invoice_Date" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="marbal_length" type="text" class="form-control @error('marbal_length') is-invalid @enderror" name="marbal_length" value="{{$data['s']->marbal_length}}" required autocomplete="marbal_length" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="text" class="form-control @error('price') is-invalid @enderror" name="price" value="{{$data['s']->price}}" required autocomplete="price" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="SubTotal" type="text" class="form-control @error('SubTotal') is-invalid @enderror" name="SubTotal" value="{{$data['s']->SubTotal}}" required autocomplete="SubTotal" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="VAT_Per" type="text" class="form-control @error('VAT_Per') is-invalid @enderror" name="VAT_Per" value="{{$data['s']->VAT_Per}}" required autocomplete="VAT_Per" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="VAT_Amount" type="text" class="form-control @error('VAT_Amount') is-invalid @enderror" name="VAT_Amount" value="{{$data['s']->VAT_Amount}}" required autocomplete="VAT_Amount" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Discount_Per" type="text" class="form-control @error('Discount_Per') is-invalid @enderror" name="Discount_Per" value="{{$data['s']->Discount_Per}}" required autocomplete="Discount_Per" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Discount_Amount" type="text" class="form-control @error('Discount_Amount') is-invalid @enderror" name="Discount_Amount" value="{{$data['s']->Discount_Amount}}" required autocomplete="Discount_Amount" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Grand_Total" type="text" class="form-control @error('Grand_Total') is-invalid @enderror" name="Grand_Total" value="{{$data['s']->Grand_Total}}" required autocomplete="Grand_Total" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Total_Payment" type="text" class="form-control @error('Total_Payment') is-invalid @enderror" name="Total_Payment" value="{{$data['s']->Total_Payment}}" required autocomplete="Total_Payment" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="PaymentDue" type="text" class="form-control @error('PaymentDue') is-invalid @enderror" name="PaymentDue" value="{{$data['s']->PaymentDue}}" required autocomplete="PaymentDue" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="pit" name="PaymentType" class="form-control">
                                <option> -- Select --</option>
...
<script>
    ...
    document.getElementById('Product_Id').value=document.getElementById('pi').value;
    document.getElementById('Customer_Id').value=document.getElementById('ci').value;
