                ...
                <div class="card-body">
                    <form method="POST" action="/Supplier">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Supplier_Id" type="text" class="form-control @error('Supplier_Id') is-invalid @enderror" name="Supplier_Id" value="{{ old('Supplier_Id') }}" required autocomplete="Supplier_Id" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Supplier_Name" type="text" class="form-control @error('Supplier_Name') is-invalid @enderror" name="Supplier_Name" value="{{ old('Supplier_Name') }}" required autocomplete="Supplier_Name" autofocus>
