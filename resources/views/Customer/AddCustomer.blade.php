...
<div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="background-color:transparent;">{{ __('Customer') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="/Customer">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Customer_Name" type="text" class="form-control @error('Customer_Name') is-invalid @enderror" name="Customer_Name" value="{{ old('Customer_Name') }}" required autocomplete="Supplier_Name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Customer_Address" type="text" class="form-control @error('Customer_Address') is-invalid @enderror" name="Customer_Address" value="{{ old('Customer_Address') }}" required autocomplete="Customer_Address" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Contact_No2" type="text" class="form-control @error('Contact_No2') is-invalid @enderror" name="Contact_No2" value="{{ old('Contact_No2') }}" required autocomplete="Contact_No2" autofocus>
